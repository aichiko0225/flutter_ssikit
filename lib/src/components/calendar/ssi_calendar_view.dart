...
class SsiCalendarView extends StatefulWidget {
  const SsiCalendarView(
      {Key? key,
...
class _CustomCalendarViewState extends State<SsiCalendarView> {
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: isPreIconEnable
                    ? SsikitTools.getAssetImage(SsiAsset.ICON_CALENDAR_PRE_MONTH)
                    : SsikitTools.getAssetImageWithColor(
                        SsiAsset.ICON_CALENDAR_PRE_MONTH, Color(0xFFCCCCCC)),
              ...
              child: Container(
                ...
                child: isNextIconEnable
                    ? SsikitTools.getAssetImage(
                        SsiAsset.ICON_CALENDAR_NEXT_MONTH)
                    : SsikitTools.getAssetImageWithColor(
                        SsiAsset.ICON_CALENDAR_NEXT_MONTH, Color(0xFFCCCCCC)),
                alignment: Alignment.center,
              ),
            )
          ],
