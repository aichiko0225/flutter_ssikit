...
///
/// ```dart
/// SsiTagCustom(tagText: '标签',)
///
/// SsiTagCustom(tagText: '标签',backgroundColor:Colors.red)
/// ```
///
class SsiTagCustom extends StatelessWidget {
  /// 标签的文字
  ...
  SsiTagCustom.buildBorderTag({
    ...
    double borderRadius = 3,
        ...
        textColor =
            textColor ?? SsiThemeConfigurator.instance.getConfig()?.commonConfig?.brandPrimary,
        super(key: key);

  @override
  Widget build(BuildContext context) {
    BorderRadius bRadius = tagBorderRadius;
    return Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            fontSize: fontSize,
            color: textColor ??
                SsiThemeConfigurator.instance.getConfig()?.commonConfig?.colorTextBaseInverse,
