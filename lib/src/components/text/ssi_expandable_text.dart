...
///
/// 相关文本组件如下:
///  * [SsiBubbleText], 气泡背景的展开收起文本组件
///  * [SsiInsertInfo], 气泡背景的文本组件
///
class SsiExpandableText extends StatefulWidget {
  ///显示的文本
  final String text;
...
class _SsiExpandableTextState extends State<SsiExpandableText> {
