...
/// 可以在Android 风格下使用的 CupertinoActivityIndicator
class SsiCupertinoActivityIndicator extends StatefulWidget {
  final Color? valueColor;

  /// Creates an iOS-style activity indicator that spins clockwise.
  const SsiCupertinoActivityIndicator(
      {Key? key,
      this.animating = true,
...
class _CupertinoActivityIndicatorState
    extends State<SsiCupertinoActivityIndicator>
