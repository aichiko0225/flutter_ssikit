...
/// 虚线分割线
class SsiDashedLine extends StatelessWidget {
  /// 默认虚线方向
  ...
  /// 默认颜色
  static final Color? _normalColor =
      SsiThemeConfigurator.instance.getConfig()?.commonConfig?.dividerColorBase;

  /// 默认位置，头部
  static const SsiDashedLinePosition _normalPosition =
      SsiDashedLinePosition.leading;
  ...
  final SsiDashedLinePosition position;
...
class SsiDashedPainter extends CustomPainter {
  /// 虚线方向
  final Axis axis;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (axis == Axis.horizontal) {
      ...
      double height = 0;
      if (position == SsiDashedLinePosition.leading) {
        // 头部
