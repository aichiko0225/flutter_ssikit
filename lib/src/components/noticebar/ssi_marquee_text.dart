...
class SsiMarqueeText extends StatefulWidget {
  ///滚动文字（不超过设置的宽度不滚动）
  final String text;
  ...
  State<StatefulWidget> createState() {
    return SsiMarqueeTextState();
  }
}

class SsiMarqueeTextState extends State<SsiMarqueeText>
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPersistentFrameCallback((timeStamp) {
      ...
      if (calculateTextWith(
              ...
              widget.textStyle?.fontWeight ?? FontWeight.normal,
              double.infinity,
              1,
              context) >
          widget.width) {
