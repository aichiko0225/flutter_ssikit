...
class SsiNoticeBar extends StatelessWidget {
  /// 自定义左边的图标
...
class NoticeStyles {
  ...
  static NoticeStyle failWithArrow = NoticeStyle(
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_FAIL),
      Color(0xFFFA3F3F),
      Color(0xFFFEEDED),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_ARROW_RED));
  ...
  static NoticeStyle failWithClose = NoticeStyle(
      ...
      Color(0xFFFA3F3F),
      Color(0xFFFEEDED),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_CLOSE_RED));

  ///蓝色+进行中+箭头
  static NoticeStyle runningWithArrow = NoticeStyle(
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_RUNNING),
      Color(0xFF0984F9),
      Color(0xFFE0EDFF),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_ARROW_BLUE));
  ...
  static NoticeStyle runningWithClose = NoticeStyle(
      ...
      Color(0xFF0984F9),
      Color(0xFFE0EDFF),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_CLOSE_BLUE));

  ///绿色+完成+箭头
  static NoticeStyle succeedWithArrow = NoticeStyle(
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_SUCCEED),
      Color(0xFF00AE66),
      Color(0xFFEBFFF7),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_ARROW_GREEN));
  ...
  static NoticeStyle succeedWithClose = NoticeStyle(
      ...
      Color(0xFF00AE66),
      Color(0xFFEBFFF7),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_CLOSE_GREEN));

  ///橘色+警告+箭头
  static NoticeStyle warningWithArrow = NoticeStyle(
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_WARNING),
      Color(0xFFFAAD14),
      Color(0xFFFDFCEC),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_ARROW_ORANGE));
  ...
  static NoticeStyle warningWithClose = NoticeStyle(
      ...
      Color(0xFFFAAD14),
      Color(0xFFFDFCEC),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_CLOSE_ORANGE));

  ///橘色+通知+箭头
  static NoticeStyle normalNoticeWithArrow = NoticeStyle(
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE),
      Color(0xFFFAAD14),
      Color(0xFFFDFCEC),
      SsikitTools.getAssetImage(SsiAsset.ICON_NOTICE_ARROW_ORANGE));
