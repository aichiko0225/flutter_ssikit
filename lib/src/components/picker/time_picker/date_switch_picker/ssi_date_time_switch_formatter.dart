...
import 'ssi_date_switch_picker.dart';


const String DATE_FORMAT_SEPARATOR = r'[|,-\._: ]+';

class DateTimeSwitchFormatter {
  ...
  static String generateDateFormat(String? dateFormat, SsiDateTimeSwitchPickerMode pickerMode) {
  ...
  static List<String> splitDateFormat(String? dateFormat, {SsiDateTimeSwitchPickerMode mode = SsiDateTimeSwitchPickerMode.date}) {
    if (dateFormat == null || dateFormat.isEmpty) {
      return [];
    }
    List<String> result = dateFormat.split(RegExp(DATE_FORMAT_SEPARATOR));
    if (mode == SsiDateTimeSwitchPickerMode.datetime) {
