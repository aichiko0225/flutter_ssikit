...
import 'date_picker/ssi_date_picker.dart';
// import 'date_range_picker/ssi_date_range_picker.dart';
...
class DateTimeFormatter {
  static DateTime? convertStringToDate(String format, String date) {
    if (SsikitTools.isEmpty(format) || SsikitTools.isEmpty(date)) return null;
  ...
  static String generateDateFormat(String? dateFormat, SsiDateTimePickerMode pickerMode) {
  ...
  //     String? dateFormat, SsiDateTimeRangePickerMode pickerMode) {
  //   if (dateFormat != null && dateFormat.isNotEmpty) {
  //     return dateFormat;
  //   }
  //   switch (pickerMode) {
  //     case SsiDateTimeRangePickerMode.date:
  //       return DATETIME_RANGE_PICKER_DATE_FORMAT;
  //     case SsiDateTimeRangePickerMode.time:
  ...
  static List<String> splitDateFormat(String? dateFormat, {SsiDateTimePickerMode mode = SsiDateTimePickerMode.date}) {
    if (dateFormat == null || dateFormat.isEmpty) {
      return [];
    }
    List<String> result = dateFormat.split(RegExp(DATE_FORMAT_SEPARATOR));
    if (mode == SsiDateTimePickerMode.datetime) {
