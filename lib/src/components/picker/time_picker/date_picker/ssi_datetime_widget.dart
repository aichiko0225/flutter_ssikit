...
class SsiDateTimeWidget extends StatefulWidget {
  SsiDateTimeWidget({
    Key? key,
    this.minDateTime,
    this.maxDateTime,
  ...
  State<StatefulWidget> createState() =>
      _SsiDateTimeWidgetState(minDateTime, maxDateTime, initDateTime, minuteDivider);
}

class _SsiDateTimeWidgetState extends State<SsiDateTimeWidget> {
