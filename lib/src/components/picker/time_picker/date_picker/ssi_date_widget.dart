...
class SsiDateWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _SsiDateWidgetState(this.minDateTime, this.maxDateTime, this.initialDateTime);
}

class _SsiDateWidgetState extends State<SsiDateWidget> {
  ...
  _SsiDateWidgetState(DateTime? minDateTime, DateTime? maxDateTime, DateTime? initialDateTime) {
