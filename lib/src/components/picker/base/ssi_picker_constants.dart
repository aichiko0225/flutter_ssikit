...
const TextStyle DATETIME_PICKER_ITEM_TEXT_STYLE = TextStyle(color: Color(0xFF222222), fontSize: 18.0);
...
/// Default value of DatePicker's item [TextStyle].
const TextStyle PICKER_ITEM_TEXT_STYLE = TextStyle(color: Color(0xFF222222), fontSize: 18.0);
