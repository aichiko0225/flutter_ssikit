...
class SsiPicker extends StatefulWidget {
...
class _CupertinoPickerState extends State<SsiPicker> {
  ...
  @override
  void didUpdateWidget(SsiPicker oldWidget) {
          ...
          Container(
            decoration: BoxDecoration(
              border: Border(
                ...
                top: BorderSide(width: 0.5, color: widget.lineColor),
                bottom: BorderSide(width: 0.5, color: widget.lineColor),
              ),
            ),
