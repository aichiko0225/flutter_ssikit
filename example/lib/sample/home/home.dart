...
import 'package:flutter_ssikit_example/sample/components/dialog/dialog_entry_page.dart';
...
class HomePage extends StatelessWidget {
  Map<String, WidgetBuilder> demoList = {
    ...
    'MultiPickerExamplePage': (context) {
    ...
    'dialog组件': (context) {
      return const DialogEntryPage('弹窗组件');
    }
  };
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.of(context)
                          .push(MaterialPageRoute(builder: demoList[text]!));
                    },
                    child: Text(text)),
              );
            }));
