...
class SsiNoticeBarOtherExample extends StatelessWidget {
      ...
      body: SingleChildScrollView(
          child: Column(
            ...
            SsiNoticeBar(
              ...
              onNoticeTap: () {
                SsiToast.show('点击通知', context);
              },
              onRightIconTap: () {
                SsiToast.show('点击右侧图标', context);
              },
            ),
            Text(
              '跑马灯',
            ...
            SsiNoticeBar(
              ...
              // 背景色
              leftWidget: SsikitTools.getAssetImage(SsiAsset.iconMore),

              ///左侧图标
              rightWidget: SsikitTools.getAssetImage(SsiAsset.iconMore),
